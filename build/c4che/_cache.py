...
EXAMPLE_DIRECTORIES = ['energy', 'tcp', 'traffic-control', 'error-model', 'matrix-topology', 'ipv6', 'udp', 'udp-client-server', 'realtime', 'socket', 'naming', 'routing', 'wireless', 'tutorial', 'stats']
...
NS3_EXECUTABLE_PATH = ['/root/repos/ns-3-allinone/ns-3-dev/build/src/fd-net-device', '/root/repos/ns-3-allinone/ns-3-dev/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/6', '/root/repos/ns-3-allinone/ns-3-dev/build']
...
VALGRIND_FOUND = True
VERSION = '3-dev'
WITH_PYBINDGEN = '/root/repos/ns-3-allinone/pybindgen'
WL_SONAME_SUPPORTED = True
cfg_files = ['/root/repos/ns-3-allinone/ns-3-dev/build/ns3/config-store-config.h', '/root/repos/ns-3-allinone/ns-3-dev/build/ns3/core-config.h']
cprogram_PATTERN = '%s'

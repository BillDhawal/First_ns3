...
PyNs3QueueDisc__PythonHelper::_wrap_Drop(PyNs3QueueDisc *self, PyObject *args, PyObject *kwargs)
{
    ...
    helper->Drop__parent_caller(ns3::Ptr< ns3::QueueDiscItem  > (item_ptr));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
_wrap_PyNs3QueueDisc_SetParentDropCallback(PyNs3QueueDisc *self, PyObject *args, PyObject *kwargs)
{
    ...
    (helper_class == NULL)? (self->obj->SetParentDropCallback(ns3::Callback<void, ns3::Ptr<ns3::QueueDiscItem const>, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> (cb_cb_impl))) : (self->obj->ns3::QueueDisc::SetParentDropCallback(ns3::Callback<void, ns3::Ptr<ns3::QueueDiscItem const>, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> (cb_cb_impl)));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyMethodDef PyNs3QueueDisc_methods[] = {
    ...
    {(char *) "SetParentDropCallback", (PyCFunction) _wrap_PyNs3QueueDisc_SetParentDropCallback, METH_KEYWORDS|METH_VARARGS, "SetParentDropCallback(cb)\n\ntype: cb: ns3::Callback< void, ns3::Ptr< ns3::QueueDiscItem const >, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >" },
...
static PyObject* _wrap_PyNs3RedQueueDiscStats__get_forcedMark(PyNs3RedQueueDiscStats *self, void * PYBINDGEN_UNUSED(closure))
{
    PyObject *py_retval;
    
    py_retval = Py_BuildValue((char *) "N", PyLong_FromUnsignedLong(self->obj->forcedMark));
    return py_retval;
}
static int _wrap_PyNs3RedQueueDiscStats__set_forcedMark(PyNs3RedQueueDiscStats *self, PyObject *value, void * PYBINDGEN_UNUSED(closure))
{
    PyObject *py_retval;
    
    py_retval = Py_BuildValue((char *) "(O)", value);
    if (!PyArg_ParseTuple(py_retval, (char *) "I", &self->obj->forcedMark)) {
        Py_DECREF(py_retval);
        return -1;
    }
    Py_DECREF(py_retval);
...
static PyObject* _wrap_PyNs3RedQueueDiscStats__get_unforcedMark(PyNs3RedQueueDiscStats *self, void * PYBINDGEN_UNUSED(closure))
{
    PyObject *py_retval;
    
    py_retval = Py_BuildValue((char *) "N", PyLong_FromUnsignedLong(self->obj->unforcedMark));
    return py_retval;
}
static int _wrap_PyNs3RedQueueDiscStats__set_unforcedMark(PyNs3RedQueueDiscStats *self, PyObject *value, void * PYBINDGEN_UNUSED(closure))
{
    PyObject *py_retval;
    
    py_retval = Py_BuildValue((char *) "(O)", value);
    if (!PyArg_ParseTuple(py_retval, (char *) "I", &self->obj->unforcedMark)) {
        Py_DECREF(py_retval);
        return -1;
    }
    Py_DECREF(py_retval);
...
static PyGetSetDef PyNs3RedQueueDiscStats__getsets[] = {
    {
        (char*) "unforcedMark", /* attribute name */
        (getter) _wrap_PyNs3RedQueueDiscStats__get_unforcedMark, /* C function to get the attribute */
        (setter) _wrap_PyNs3RedQueueDiscStats__set_unforcedMark, /* C function to set the attribute */
        NULL, /* optional doc string */
        NULL /* optional additional data for getter and setter */
    },
    {
        (char*) "forcedMark", /* attribute name */
        (getter) _wrap_PyNs3RedQueueDiscStats__get_forcedMark, /* C function to get the attribute */
        (setter) _wrap_PyNs3RedQueueDiscStats__set_forcedMark, /* C function to set the attribute */
        NULL, /* optional doc string */
        NULL /* optional additional data for getter and setter */
    },
    {

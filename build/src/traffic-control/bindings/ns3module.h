...
public:
    ...
    inline void Drop__parent_caller(ns3::Ptr< ns3::QueueDiscItem const > item)
...
class PythonCallbackImpl2 : public ns3::CallbackImpl<void, ns3::Ptr<ns3::QueueDiscItem const>, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>
{
public:
    PyObject *m_callback;
